...
- Searchable all-fish guide with mooch paths and per-hole bait recommendations, which remembers its search and selected fish between opens
- Native UI, built on KamiToolKit, with a resizable fish/details divider (lockable in settings)
